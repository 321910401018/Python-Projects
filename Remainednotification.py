...
t = Tk()
t.title('Notification Remainder')
t.geometry("500x500")
...
def get_details():
    ...
    if get_title == "" or get_msg == "" or get_time == "":
        ...
        messagebox.showinfo("notifier set", "do you want to set?")
        t.destroy()
        time.sleep(min_to_sec)

        notification.notify(title=get_title,
                            message=get_msg,
                            app_name="Notification remainder",
                            app_icon="image2.ico",
                            toast=True,
                            timeout=10)
...
# Button
but = Button(t, text="SET", font=("poppins", 10, "bold"), fg="#ffffff", bg="#528DFF", width=20,
             relief="raised",
             command=get_details)
